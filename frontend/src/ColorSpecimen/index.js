  ...
  return (
    <div className={classes.join(" ")}>
      {colors.map((c) => {
        ...
        return <div className={classes.join(" ")} key={c.id} onClick={() => { copyTextToClipboard(c.value) }}>
          ...
          <div className="color-sample__name">{c.name} <span className="color-sample__id">({c.id})</span></div>
